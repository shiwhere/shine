# Generated by Django 5.2.4 on 2025-08-05 22:36
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='women',
            name='is_published',
            field=models.BooleanField(choices=[(False, 'chernovik'), (True, 'published')], default=0, verbose_name='Статус'),
        ),
        migrations.AlterField(
            model_name='women',
            name='slug',
            field=models.SlugField(max_length=255, unique=True, validators=[django.core.validators.MinLengthValidator(5, message='slug must be at least 5 characters'), django.core.validators.MaxLengthValidator(100, message='slug must be at most 100 characters')], verbose_name='Cлаг'),
        ),
        migrations.AlterField(
            model_name='women',
            name='tags',
